...
def fit_single_frame(img,
    ...
    if save_meshes or visualize:
        ...
        global_orient = torch.tensor([1.2092, 1.2092, 1.2092], device='cuda:0', requires_grad=True).unsqueeze(0)
        ...
        print("joint x forward, z up: ",joints)
        #save joints as json
        import json
        ...
        scale_transform = trimesh.transformations.scale_matrix(1000, [0, 0, 0])
        out_mesh.apply_transform(scale_transform)
        mesh_fn = "output.stl"  # Replace with your desired file name
        out_mesh.export(mesh_fn, file_type='stl')
